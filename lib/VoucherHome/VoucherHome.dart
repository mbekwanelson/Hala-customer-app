...
class _ImageCaptureState extends State<ImageCapture> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    File selected = await ImagePicker().pickImage(source: source)
        as File; //allows user to either select image from gallery or capture a new one with a camera
...
//      toolbarTitle:"Crop it "
    ...
    setState(() {
      _imageFile = cropped ??
          _imageFile; // if user cancels modifications return the origional image file (uncropped)
    });
  }
