...
class _MyListViewPhoneState extends State<MyListViewPhone> {
  ...
  Widget build(BuildContext context) {
    print("mylistviewphone build");
    print("food items: ${widget.foodAndConnect}");
              ...
              return Padding(
                ...
                child: Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      print(
                          "settings panel btn clicked for ${widget.foodAndConnect[index].category}");
